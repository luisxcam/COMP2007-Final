<%@ Page Title="EnemyList" Language="C#" MasterPageFile="~/Default.Master" CodeBehind="Default.aspx.cs" Inherits="COMP2007_Final_SteveEd.Enemies.Default" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div>
        <asp:ListView id="ListView1" runat="server"
			...
			ItemType="COMP2007_Final_SteveEd.Models.Enemy"
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Enemies/Details", Item.EnemyId) %>' Text="Details" /> | 
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Enemies/Edit", Item.EnemyId) %>' Text="Edit" /> | 
                        <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Enemies/Delete", Item.EnemyId) %>' Text="Delete" />
                    </td>
                </tr>
            </ItemTemplate>
        </asp:ListView>
