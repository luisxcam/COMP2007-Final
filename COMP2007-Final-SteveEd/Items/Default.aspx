<%@ Page Title="ItemList" Language="C#" MasterPageFile="~/Default.Master" CodeBehind="Default.aspx.cs" Inherits="COMP2007_Final_SteveEd.Items.Default" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="itemListTable">
        <asp:ListView id="ListView1" runat="server"
            DataKeyNames="ItemId" 
			ItemType="COMP2007_Final_SteveEd.Models.Item"
