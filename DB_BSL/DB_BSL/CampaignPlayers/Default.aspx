<%@ Page Title="CampaignPlayerList" Language="C#" MasterPageFile="~/MasterPages\Default.Master" CodeBehind="Default.aspx.cs" Inherits="DB_BSL.CampaignPlayers.Default" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div>
        <asp:ListView id="ListView1" runat="server"
			...
			ItemType="DB_BSL.Models.CampaignPlayer"
