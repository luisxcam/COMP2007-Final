        ...
        <asp:FormView runat="server"
            ...
            <InsertItemTemplate>
                <fieldset class="form-horizontal">
                    ...
                    <div>
                        <asp:Label ID="Label1" runat="server" Text="JobSpecific"></asp:Label>
                        <asp:DynamicControl Mode="Insert" DataField="AttackRate" runat="server" CssClass="form-control" />
                    </div>
                    <div>
                        <asp:Label ID="Label2" runat="server" Text="JobSpecific"></asp:Label>
                        <asp:DynamicControl Mode="Insert" DataField="MagicAttack" runat="server" CssClass="form-control" />
                    </div>
                    <div>
                        <asp:Label ID="Label3" runat="server" Text="JobSpecific"></asp:Label>
                        <asp:DynamicControl Mode="Insert" DataField="Weight" runat="server" CssClass="form-control" />
                    </div>
                    ...
                    <div>
                        <asp:Label ID="Label4" runat="server" Text="JobSpecific"></asp:Label>
                        <asp:DynamicControl Mode="Insert" DataField="Enchantment" runat="server" CssClass="form-control" />
                    </div>
                    <div>
                        <asp:Label ID="Label5" runat="server" Text="JobSpecific"></asp:Label>
                        <asp:DynamicControl Mode="Insert" DataField="MonetaryValue" runat="server" CssClass="form-control" />
                    </div>
