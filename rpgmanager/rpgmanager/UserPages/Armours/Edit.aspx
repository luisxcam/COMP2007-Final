        ...
        <asp:FormView runat="server"
            ...
            <EditItemTemplate>
                <fieldset class="form-horizontal">
                    ...
                    <div>
                        <asp:Label ID="DefenseRateLabel" runat="server" Text="Defence Rate"></asp:Label>
                        <asp:DynamicControl Mode="Edit" CssClass="form-control" DataField="DefenseRate" runat="server" />
                    </div>
                    <div>
                    ...
                    <div>
                        <asp:Label ID="MonetaryValueLabel" runat="server" Text="Monetary"></asp:Label>
