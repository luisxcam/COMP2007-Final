<%@ Page Title="WeaponList" Language="C#" MasterPageFile="~/Default.Master" CodeBehind="Default.aspx.cs" Inherits="COMP2007_Final_SteveEd.Weapons.Default" %>
    ...
    <div class="dashboard_container">
        ...
        <div>
            <asp:ListView ID="ListView1" runat="server"
                ...
                ItemType="COMP2007_Final_SteveEd.Models.Weapon"
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Weapons/Details", Item.WeaponId) %>' Text="Details" />
                            | 
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Weapons/Edit", Item.WeaponId) %>' Text="Edit" />
                            | 
                        <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Weapons/Delete", Item.WeaponId) %>' Text="Delete" />
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:ListView>
